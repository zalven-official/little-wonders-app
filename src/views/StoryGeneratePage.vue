<template>
  <MainLayout :is-loading="isLoading">
    ...
    <OralStoryGenerator @update:isLoading="handleIsLoadingUpdate" :is-loading="isLoading"
...
import OralStoryGenerator from '@/components/modules/story/OralStoryGenerator.vue'
